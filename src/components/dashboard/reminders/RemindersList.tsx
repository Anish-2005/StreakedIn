...
export default function RemindersList({ reminders, onEdit, onDelete, onToggle }: RemindersListProps) {
  if (reminders.length === 0) {
    return (
      <div className="text-center py-12 bg-slate-800 light:bg-white/30 backdrop-blur-md border border-slate-700 light:border-slate-300/50 rounded-xl">
        <Bell className="w-12 h-12 text-slate-500 mx-auto mb-4" />
        <p className="text-slate-400 light:text-slate-600">No reminders set up yet</p>
