    ...
    <section className="relative min-h-screen flex items-center justify-center pt-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center px-4 py-2 rounded-full bg-gray-200/50 dark:bg-slate-800/50 backdrop-blur-md border border-gray-300/50 dark:border-slate-700/50"
          >
            <Award className="w-4 h-4 text-yellow-400 mr-2" />
            <span className="text-sm text-gray-700 dark:text-slate-300">Trusted by 10,000+ professionals</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-gray-700 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed"
          >
          ...
          >
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-gray-600 dark:text-slate-400 text-sm mt-1">{stat.label}</div>
              </div>
            ))}
          </motion.div>
        </motion.div>
      ...
      >
        <motion.div
          ...
          className="flex flex-col items-center space-y-2 text-gray-500 dark:text-slate-400"
        >
